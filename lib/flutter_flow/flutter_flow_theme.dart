...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color navigationIconSelected = const Color(0xFF000000);
  late Color navigationIconUnselected = const Color(0xFF505050);
  late Color settingsButtons = const Color(0xFF1E1E1E);
  late Color background = const Color(0xFF1A1F24);
  late Color filledProgressBattery = const Color(0xFF39D2C0);
  late Color unfilledProgressBattery = const Color(0xFFDBE2E7);
  late Color eesIconsColor = const Color(0xFF0F2B0D);
  late Color pieChartColor = const Color(0xFF2B0A3F);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color navigationIconSelected = const Color(0xFFFFFFFF);
  late Color navigationIconUnselected = const Color(0xFF505050);
  late Color settingsButtons = const Color(0xFF1E1E1E);
  late Color background = const Color(0xFF1A1F24);
  late Color filledProgressBattery = const Color(0xFF39D2C0);
  late Color unfilledProgressBattery = const Color(0xFF323B45);
  late Color eesIconsColor = const Color(0xFF1CFF00);
  late Color pieChartColor = const Color(0x2754A04F);
}
